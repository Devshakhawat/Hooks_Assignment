<div class='wrap'>
    <h1 class="wp-heading-inline"><?php esc_html_e( 'Edit Address', 'cfupdate' ) ?></h1>
    <?php if ( isset( $_GET['address-updated'] ) ) { ?>
        <div class="notice notice-success">
            <p><?php esc_html_e( 'Address has been updated successfully!', 'cfupdate' ); ?></p>
        </div>
    <?php } ?>
    ...
    <form method= "post">
        ...
        <?php submit_button( __('Update', 'cfupdate' ), 'primary', 'submit_button'); ?>
    </form>
