...
class Wedevs_Books {
    ...
    public function __construct() {
        add_action( 'init', array( $this, 'wdp_custom_book_post' ) );
        add_action( 'add_meta_boxes', array( $this, 'wdp_metabox_declaration' ) );
        add_action( 'save_post', array( $this, 'wdp_save_book_data' ) );
    }
    ...
    public function wdp_custom_book_post() {
        ...
        $args = array(
            'labels'     => $labels,
            'supports'   => array( 'title', 'editor', 'thumbnail', 'category', 'comments' ),
            'public'     => true,
            'rewrite'    => array( 'slug' => 'my-books' ),
