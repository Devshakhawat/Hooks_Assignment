...
**Folder Three:** I have collected admin email and send an email on each post published
...
**Assignment_Fourteen:** Added two plugins inside this folder. 
*rp-widget:*  Added a widget where user can select categories, number of posts and based on these data it will show posts title on widget.
*subscription-form:* 
